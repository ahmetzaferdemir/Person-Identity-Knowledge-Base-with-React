      ...
      <div className="row g-5 mt-5 mx-auto my-auto">
        ...
        <div className="col-sm-12 col-md-5">
          <div className="form-control p-3">
            ...
            <label className='fw-bold'>Name -Surname</label>
            <input type="text" className="form-control" value={nameSurname} onChange={(e) => setNameSurname(e.target.value)}/>
            ...
            <div className='text-end'>
              <button className="btn btn-outline-warning mt-3">Update</button>
            </div>
          </div>
        </div>
