  ...
  return (
    ...
    <div className="container">
      <div className="row g-5 mt-5 mx-auto my-auto">
        <h1 className='h1 py-2 px-5'>Get User Info</h1>
        <div className="col-sm-12 col-md-5">
          <div className="form-control p-3">
            ...
            <div className='text-end'>
              <button className="btn btn-outline-warning mt-3">Get</button>
            </div>
          </div>
        </div>
              ...
              <div className="col-sm-12 col-md-8">
                ...
                <div className="row userInfo bg-warning rounded">
                    <div className="col userName">
                      Username <br /> <span className='p-1 text-muted fst-italic'>johndoe132</span>
                    </div>
